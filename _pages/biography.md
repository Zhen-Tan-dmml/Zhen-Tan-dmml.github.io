...
**Memberships:** IEEE, AAAI, ACM, SIAM, AAAS

**Journal Reviewer:** IEEE TPAMI; IEEE TNNLS; IEEE TKDE; ACM TKDD

**Area Chair:** IEEE DSAA 2025

**Conference Program Committees / Reviewer:**  
- *Data Mining & Information Retrieval:* KDD, WWW, WSDM, SIGIR, etc. (2022–present)  
- *Machine Learning & AI:* ICLR, ICML, NeurIPS, AAAI, IJCAI, AISTATS etc. (2023–present)  
- *Natural Language Processing:* ACL, EMNLP, NAACL, EACL, etc. (2023–present)  
- *Computer Vision:* CVPR, ICCV, ECCV, etc. (2024–present)

**Workshop & Tutorial Organization:**
- **Workshop:** *Lock-LLM: Prevent Unauthorized Knowledge Use from Large Language Models* — Deep dive into un-distillable, un-finetunable, un-compressible, un-editable, and un-usable LLMs.  
  Organized by **Z. Tan** *et al.* at NeurIPS 2025.  
  [Website 🔗](https://lock-llm.github.io/)
- **Tutorial:** *Explaining the ‘Unexplainable’ Large Language Models*.  
  Presented by **Z. Tan** *et al.* at ICDM 2025.
- **Tutorial:** *Explaining the ‘Unexplainable’ Large Language Models*.  
  Presented by **Z. Tan** *et al.* at WSDM 2026.
...
- Google Cloud Academic Research Award *(2025)*
- OpenAI Researcher Access Award *(2025)*
- Gemma Academic Program GCP Credit Award *(2024)*
- ASU Fulton Fellowship *(2021)*

**Travel Awards**
- AAAI Student Travel Award *(2024, 2025)*
- SDM Student Travel Award *(2024, 2025)*
